...
4. modify `vessel_data_dir` cfg item in `utils/config.py`, or pass it to program using argument like `--voc-data-dir=/path/to/VOCdevkit/VOC2007/` .
...
- `--vessel_data_dir`: where the VOC data stored
